...
export class DatabaseConnectionPOST {
    ...
    constructor() {
        ...
        this.prisma.$connect().then((_) => {
            log(`Conexão com Banco de Dados [DatabaseConnectionPOST] estabelecida com sucesso`);
        });
    }
    // metodos para consumidores
    async createCustomer(consumidor, localizacao) {
        try {
    ...
    async fromCustomerAddToWishList({ id_consumidor, id_produto, }) {
        try {
            const exists = await this.prisma["produtoFavorito"].findUnique({
                where: {
    ...
    async addToCart({ id_consumidor, id_produto }) {
        try {
    ...
    async createFarvoriteFarm({ id_consumidor, id_fazenda, }) {
        try {
            const alreadyExistsInFavoriteFarm = await this.prisma["fazendaFavorita"].findUnique({
                where: {
    ...
    async createFarmer({ fazendeiro, localizacao }) {
        try {
    ...
    async createFarm({ id_fazendeiro, farm }) {
        try {
    ...
    async createProduct({ id_fazenda, nome_categoria, produto, }) {
        try {
    ...
    async sellProduct({ id_consumidor, id_produto }) {
        try {
    ...
    async createEmployee({ id_fazenda, id_consumidor, privilegio, }) {
        try {
    ...
    async createClient({ id_consumidor, id_fazenda }) {
        try {
            ...
            console.error("An Error Ocurred when i tried create Clients from the Farm " +
                id_fazenda);
            console.error(error);
        }
        finally {
...
export class DatabaseConnectionGET {
    ...
    constructor() {
        this.prisma = new PrismaClient();
        this.prisma.$connect().then((_) => {
            log(`Conexão com Banco de Dados [DatabaseConnectionGET] estabelecida com sucesso`);
        });
    }
    // GET PUBLICS
    async getCostumers(limit) {
        try {
            if (limit) {
    ...
    async getSoldProducts(id_fazenda, limit) {
        const these = {
    ...
    async getSoldProduct(id_fazenda, id_monitoramento, limit) {
        const these = {
            id_monitoramento: true,
            consumidor: {
                select: {
    ...
    async fromFarmGetProduct(id_fazenda, id_produto) {
        try {
    ...
    async fromFarmGetProductSolds(id_fazenda) {
        try {
            const farm = await this.farmExists(id_fazenda);
            if (!farm || 'error' in farm) {
                const object_error = farm;
    ...
    async fromFarmGetStock(id_fazenda, products = false) {
        try {
            const farm = await this.farmExists(id_fazenda);
            if (!farm || "error" in farm) {
                const object_error = farm;
    ...
    async getCategory(id_categoria) {
        try {
    ...
    async fromFarmGetClients(id_fazenda) {
        try {
            const farm = await this.farmExists(id_fazenda);
            if (!farm || "error" in farm) {
                const object_error = farm;
    ...
    async fromFarmGetClient(id_fazenda, id_client) {
    ...
    async fromFarmGetStatistic(id_fazenda) {
        try {
            const farm = await this.farmExists(id_fazenda);
            if (!farm) {
            ...
            console.error("An Error Ocurred when i tried get Statistics from the Farm " +
                id_fazenda);
            console.error(error);
        }
        finally {
    ...
    async fromFarmGetProductsByCategory(id_fazenda, id_categoria) {
    ...
    async getProductByCategory(id_categoria) {
    ...
    async getWishListCostumer(id_consumidor) {
        try {
            ...
            console.error("An Error Ocurred when i tried get Favorite Product from the Client " +
                id_consumidor);
            console.error(error);
        }
        finally {
    ...
    async getCartCostumer(id_consumidor) {
        try {
            ...
            console.error("An Error Ocurred when i tried get Cart from the Client " +
                id_consumidor);
            console.error(error);
        }
        finally {
    ...
    async getFavoriteFarm(id_consumidor) {
        try {
            ...
            console.error("An Error Ocurred when i tried get Favorite Farm from the Client " +
                id_consumidor);
            console.error(error);
        }
        finally {
    ...
    async fromDatabaseGetUser(email) {
